<template>
	<div>
		...
		<main class="container">
			...
			<ModalWindow :modal-name="'заказчика'" v-show="showModal"  :on-click-save="save" :on-click-save-and-push="submit"/>
...
export default {
	name: "NewCustomer",
	components: { PageNameH1, ButtonBlue,ModalWindow},
	data(){
		return{
			pageName: 'Новый заказчик',
	...
	methods: {
		...
		submit(){
			console.log("Добавлен заказчик")
			this.showModal = !this.showModal
			location.reload()
		},
		save(){
			console.log("Заказчик сохранен")
			this.showModal = !this.showModal
		}
	},
}
